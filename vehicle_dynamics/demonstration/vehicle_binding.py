...
def bind_authoritative_hypercar(
    ...
    sim_cfg = SimulationConfig(
        ...
        aero_cy_beta=-0.8,
        aero_cn_beta=-0.15,
        use_sprung_body=True,
        k_front=float(definition.subsystems.suspension.ks_front),
        k_rear=float(definition.subsystems.suspension.ks_rear),
        c_front=float(definition.subsystems.suspension.cs_front),
        c_rear=float(definition.subsystems.suspension.cs_rear),
        roll_stiffness_front=35000.0,
        roll_stiffness_rear=30000.0,
        I_theta=900.0,
        I_phi=350.0,
        use_unsprung=True,
        m_u_front=40.0,
        m_u_rear=45.0,
        k_tire_front=220000.0,
